...
public interface CustomReservationRepository {
    ...
    Page<Reservation> findReservationBySpaceOwnerWithFilters(User user, StatusGroup statusGroup, Pageable pageable);

    Page<Reservation> findReservationByUserWithFilters(User user, StatusGroup statusGroup, Pageable pageable);
